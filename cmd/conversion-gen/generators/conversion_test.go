...
func TestDirect(t *testing.T) {
	builder := parser.New()
	if err := builder.LoadPackages("./internal/testtypes"); err != nil {
		t.Fatal(err)
	}
	if err := builder.LoadPackages("./internal/testtypes/example1"); err != nil {
		t.Fatal(err)
	}
	if err := builder.LoadPackages("./internal/testtypes/example2"); err != nil {
		t.Fatal(err)
	}
	...
	thisPackage := "k8s.io/code-generator/cmd/conversion-gen/generators"
	typeMapReflect := map[string]reflect.Type{
		"bool":    reflect.TypeOf(false),
		"int":     reflect.TypeOf(0),
		"string":  reflect.TypeOf(""),
		"*bool":   reflect.PointerTo(reflect.TypeOf(false)),
		"*string": reflect.PointerTo(reflect.TypeOf("")),

		thisPackage + "/internal/testtypes.BoolOrString": reflect.TypeOf(testtypes.BoolOrString{}),
		thisPackage + "/internal/testtypes.MyEnum":       reflect.TypeOf(testtypes.MyEnum(0)),
		thisPackage + "/internal/testtypes.StructA":      reflect.TypeOf(testtypes.StructA{}),
		thisPackage + "/internal/testtypes.StructB":      reflect.TypeOf(testtypes.StructB{}),

		thisPackage + "/internal/testtypes/example1.MyString":        reflect.TypeOf(example1.MyString("")),
		thisPackage + "/internal/testtypes/example1.MyStruct":        reflect.TypeOf(example1.MyStruct{}),
		"*" + thisPackage + "/internal/testtypes/example1.MyStruct":  reflect.PointerTo(reflect.TypeOf(example1.MyStruct{})),
		"[]" + thisPackage + "/internal/testtypes/example1.MyStruct": reflect.SliceOf(reflect.TypeOf(example1.MyStruct{})),

		thisPackage + "/internal/testtypes/example2.MyString":        reflect.TypeOf(example2.MyString("")),
		thisPackage + "/internal/testtypes/example2.MyStruct":        reflect.TypeOf(example2.MyStruct{}),
		"*" + thisPackage + "/internal/testtypes/example2.MyStruct":  reflect.PointerTo(reflect.TypeOf(example2.MyStruct{})),
		"[]" + thisPackage + "/internal/testtypes/example2.MyStruct": reflect.SliceOf(reflect.TypeOf(example2.MyStruct{})),
	}
